...
メンバー一覧では、各メンバーの投稿数やサイト登録日などが確認できます。<br>
登録時のニックネームでメンバー検索できます。<br>

自分の好きな楽曲にコメントを残していたメンバーのページを見にいくと、<br>
他にどのような曲に対してコメントを残しているのか等をチェックできます。<br>
各メンバーのページでは、カレンダーにその日のレビュー投稿数が記録されます。<br>
メンバーをフォローすると、自分のタイムラインにフォロワー全員のコメントが最新順で表示されます。<br>
相互フォローの場合は、その相手のページからダイレクトメッセージが送れます。<br>

リスト機能では、自分のお気に入り楽曲として管理するだけではなく、<br>
後で聴いてみたい曲、今後弾いてみたい曲としてまとめる等、メンバー独自の基準で複数作成可能です。<br>

検索機能では、楽曲検索、作曲家検索ができます。<br>
検索ボタンを押す前に候補を表示させることで、うろ覚えでの検索にも対応しています。<br>
検索結果に楽曲データがある場合には、感想を追記することができます。<br>
しかし、楽曲数は膨大であり、管理者側で楽曲データを追加する作業は大変です。<br>
そのため、検索結果に楽曲が表示されなかった場合には、<br>
メンバー側は楽曲名と作曲家名の入力を必須とし、新規追加の申請ができます。<br>
その後、管理者が申請内容を確認・承認し、その該当データが<br>
メンバー側にも表示され、感想を追記することができます。<br>
なお、メンバーは楽曲名を新規追加できるため、実際には存在しない楽曲名等を記入してしまう可能性を考慮し、<br>
管理者側では楽曲名の編集及び削除をできるようにしています。<br>

ヘルプページでは、よくある質問とサイトの詳細がチェックできます。<br>
メンバーのその他の要望については、お問い合わせにて対応可能です。
...
例えば、映画の感想がしばしば共有されているように、ピアノ楽曲においてもそうあるべきだと考えました。
